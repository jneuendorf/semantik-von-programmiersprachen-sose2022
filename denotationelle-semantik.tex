...
\begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{img/F_0}
    \label{fig:F0}
\end{figure}
...
\begin{enumerate}
    \item Für alle Zustände mit Wahrheitswert $\false$ muss der Fixpunkt eine Schleife ($\id$) liefern.
        \begin{figure}[H]
            \centering
            \includegraphics[width=.15\textwidth]{img/F_1}
            \label{fig:F1}
        \end{figure}
    \item Es gibt Zustände mit Wahrheitswert $\true$, die nach endlich vielen Schritten mit $\mathcal{S}$ (gelb) einen Zustand mit Wahrheitswert $\false$ erreichen.
        \begin{figure}[H]
            \centering
            \includegraphics[width=.35\textwidth]{img/F_2}
            \label{fig:F2}
        \end{figure}
...
\end{lstlisting}
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=.6\textwidth]{img/F_3.1}
                    \label{fig:F3_1}
                \end{figure}
...
\end{lstlisting}
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=.6\textwidth]{img/F_3.2}
                    \label{fig:F3_2}
                \end{figure}
...
\end{lstlisting}
        \begin{figure}[H]
            \centering
            \includegraphics[width=.6\textwidth]{img/F_3.3}
            \label{fig:F3_3}
        \end{figure}
        \end{enumerate}
